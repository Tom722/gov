  ...
  Table_createClass(Table, [{
    ...
    */
    ...
    value: function createTable(colCount, rowCount, options) {
      ...
      var $table = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<table>' + thead + tbody + '</table>');
...
var Editor_Editor = /*#__PURE__*/function () {
  ...
  Editor_createClass(Editor, [{
    ...
    value: function handleKeyMap(event) {
      ...
      if (keyName === 'TAB' && this.options.tabDisabled) {
        this.afterCommand();
      } else if (eventName) {
