...
class Block Extends Model
{
    ...
    {
        $value = $value ? $value : self::$config['default_block_image'];
     ...
     */
    public static function getBlockList($params,$isRender=true)
    {
        ...
        $list = self::where($where)
            ...
            ->cache($cache)
            ->select();
        if($isRender) self::render($list, $imgwidth, $imgheight);
        return $list;
    }
